...
META_DESCRIPTION    = _("LYSHOP is an online shop where we sells shoes, perfumes, smartphone, accessories and more. We deliver to Libreville and Port-Gentil in Gabon")
