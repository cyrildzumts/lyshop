...
DATE_PATTERN_REGEX                  = re.compile(r'^(?P<YEAR>\d{4})-(?P<MONTH>\d{2})-(?P<DAY>\d{2})$')
DATETIME_PATTERN_REGEX              = re.compile(r'^(?P<YEAR>\d{4})-(?P<MONTH>\d{2})-(?P<DAY>\d{2})$')
DATETIME_RANGE_FILTER_PATTERN       = re.compile(r'^(?P<START>(\d{4}-\d{2}-\d{2}))?(?:-{1,2})(?P<END>(\d{4}-\d{2}-\d{2}))?$')
DATE_RANGE_FILTER_PATTERN           = re.compile(r'^(?P<START>(\d{4}-\d{2}-\d{2}))?(?:-{1,2})(?P<END>(\d{4}-\d{2}-\d{2}))?$')
