...
### Category Slugs
CATEGORY_SLUG_CATALOG = _('catalog')
CATEGORY_SLUG_SHOES = _('shoes')
CATEGORY_SLUG_PARFUMS = _('parfums')
CATEGORY_SLUG_MODE = _('mode')
CATEGORY_SLUG_PRODUCTS = _('products')
CATEGORY_SLUG_WOMEN = _('women')
CATEGORY_SLUG_KIDS = _('kids')
CATEGORY_SLUG_GILRS = _('girls')
CATEGORY_SLUG_BOYS = _('boys')
CATEGORY_SLUG_BABIES = _('babies')
CATEGORY_SLUG_MEN = _('men')
CATEGORY_SLUG_ACCESSORIES = _('accessories')

# CATEGORIES

CATEGORY_WOMEN = _('Women')
CATEGORY_MEN = _('Men')
CATEGORY_CHILDREN = _('Children')
CATEGORY_GILRS = _('Girls')
CATEGORY_BOYS = _('Boys')
CATEGORY_EAU_DE_PARFUMS = _('Eau de Parfum')
CATEGORY_EAU_DE_TOILETTE = _('Eau de Toilette')
CATEGORY_PERFUMES = _('Perfumes')
CATEGORY_SHOES = _('Shoes')
CATEGORY_ACCESSORIES = _('Accessoires')
CATEGORY_BAGS = _('Bags')
CATEGORY_SUNGLASSES = _('Sunglasses')
CATEGORY_SCARVES = _('Scarves')
CATEGORY_SNEAKERS = _('Sneakers')
CATEGORY_SLIPPERS = _('Slippers')
CATEGORY_LOAFERS = _('Loafers')
CATEGORY_BOOTS  = _('Boots')
CATEGORY_SLIP_ON = _('Slip On')
CATEGORY_BALLERINES = _('Ballerines & Sandales')
CATEGORY_PUMPS = _('Pumps & High Heels')
CATEGORY_SETS = _('Sets')
CATEGORY_HATS = _('Hats')
CATEGORY_CLOTHINGS = _('Clothings')
CATEGORY_JEWERLY = _('Jewerly')
CATEGORY_PANTS = _('Pants')
CATEGORY_DRESSES = _('Dresses')
CATEGORY_SLIPS = _('Slips')
CATEGORY_BUSINESS_SHOES = _('Business Shoes')
CATEGORY_CASUAL_SHOES = _('Casual Shoes')
CATEGORY_SANDALES = _('Sandales')
CATEGORY_SHIRTS = _('Shirts')
CATEGORY_BODYSUITS = _('Bodysuits')
CATEGORY_SOCKS = _('Socks & Tights')
CATEGORY_ELECTRONICS = _('Electronics')
CATEGORY_SMARTPHONES = _('Smartphones')
CATEGORY_ANDROID = _('Android')
CATEGORY_IPHONE = _('iPhone')
CATEGORY_OTHERS = _('Others')
