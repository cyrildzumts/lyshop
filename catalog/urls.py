...
catalog_patterns = [
    ...
    path('category/<slug:slug>/', views.category_detail_slug, name='category-detail'),
    path('categories/products/detail/<uuid:product_uuid>/', views.product_detail, name='product-detail'),
    path('<slug:category_slug>/<slug:product_slug>/<uuid:product_uuid>/', views.product_detail_slug, name='product-detail'),
